Public Class BXP_Common
    ...
    Public NameBDInter As String = "BXP_Crossmotion"
    Public NameBDSAP As String = "Prototipo_Desarrollos"
    ...
    Public Function DeleteFile(ByVal Nombre As String) As Boolean
        Try
